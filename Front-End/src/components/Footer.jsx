...
const Footer = () => {
  return (
    <div>
   <div className='flex flex-col sm:grid grid-cols-[1fr_1fr_1fr] gap-20  text-sm'>
    <div className='sm:relative sm:pb-16'>
        <img src={assets.shiraz_logo} className=' w-24' alt="" />
